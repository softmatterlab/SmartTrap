...
class autoControllerThread(Thread):
    ...
    def __init__(self, c_p, data_channels, main_window=None):
        ...
        self.particle_lower_size_limit = 1.3/self.c_p['microns_per_pix'] # Smaller than 1 microns ish is too small to be relevant YOLO overestimates size
        self.particle_upper_size_limit = 7/self.c_p['microns_per_pix'] # Bigger than 7 microns ish is too small to be relevant
    ...
    def run(self):
        ...
        while self.c_p['program_running']:
            ...
            if self.c_p['centering_on']:
                ...
                self.trap_particle_minitweezers_alt(center)
                if self.c_p['particle_trapped']:
                    self.c_p['centering_on'] = False
                    if self.moving2trap:
                        self.moving2trap = False
